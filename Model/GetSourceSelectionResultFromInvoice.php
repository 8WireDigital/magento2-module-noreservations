<?php
/**
 * Based on Magento\InventoryShipping\Model\GetSourceSelectionResultFromInvoice overriden as by default it filters out
 * any products other than virtual ones. We need this so that we can deduct qty from a stock when an order is invoiced
 * rather than when it is shipped. Magento\InventoryShipping\Model\GetSourceSelectionResultFromInvoice is normally only
 * used for virtual products hence the filtering of others but we need this class to work for all products
 */
declare(strict_types=1);

namespace EightWire\NoReservations\Model;
